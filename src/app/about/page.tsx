  ...
  return (
    <div className="container mx-auto px-4 pt-32 pb-16">
      <div className="max-w-4xl mx-auto animate-fade-in-up">
        <h1 className="text-5xl font-cinzel text-center">About DENIZVIBEZ</h1>
        <p className="mt-4 text-xl text-center font-light text-softgold">
          ARTIFICIAL AUTHENTIC EMOTIONS
        </p>

        <div className="mt-12 space-y-8 text-offwhite/90 text-lg leading-relaxed">
          <p>
            DENIZVIBEZ was born from a simple yet profound idea: What if we could use the most advanced artificial intelligence not to replace human creativity, but to amplify it? We stand at the intersection of technology and art, crafting tools that empower creators to express emotions in new and powerful ways. Our philosophy is that AI should be a collaborator, a muse that helps unlock deeper, more authentic feelings.
          </p>
